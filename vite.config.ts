...
export default defineConfig({
  ...
  plugins: [react(), {
    ...
    registerType: 'prompt',
    includeAssets: ['apple-touch-icon-v1.8.0.png'],
    manifest: {
      ...
      icons: [
        { src: `${base}pwa-192x192-v1.8.0.png`, sizes: '192x192', type: 'image/png', purpose: 'any' },
        { src: `${base}pwa-512x512-v1.8.0.png`, sizes: '512x512', type: 'image/png', purpose: 'any' },
        { src: `${base}maskable-512x512-v1.8.0.png`, sizes: '512x512', type: 'image/png', purpose: 'maskable' },
      ],
    },
    workbox: {
